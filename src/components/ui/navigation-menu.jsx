...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center uppercase tracking-[1.2px] leading-[21px] font-ubuntu font-semibold justify-center rounded-md px-4 py-2 text-sm text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground  disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-accent/50 data-[state=open]:bg-accent/50"
);
