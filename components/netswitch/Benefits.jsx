    ...
    <section className="py-20">
      <div className=" container grid grid-cols-1 lg:grid-cols-2">
        <div className="p-5 grid gap-5">
          {/* IMAGE */}
          <div className="rounded-full w-60 h-60 flex overflow-hidden">
            <Image
              src="/about2.jpg"
              alt="benefit image"
              height={300}
          ...
          {/* TITLE */}
          <p className="text-primary font-semibold text-[40px]">
            How you benefit
          </p>
          {/* TEXT */}
          <p className="font-normal text-[20px] font-Open_sans -mt-2">
